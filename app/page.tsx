    ...
    <div className="min-h-screen flex flex-col">
      <header className="bg-green-800 text-white shadow-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-16">
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link href="/register" className="bg-yellow-500 text-black px-4 py-2 rounded-md hover:bg-yellow-400">Get Started</Link>
          </div>
        </div>
      </header>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
            <div className="bg-white p-6 rounded-xl shadow-sm border border-green-200">
              <AcademicCapIcon className="w-8 h-8 text-green-700 mb-2" />
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-green-200">
              <ClockIcon className="w-8 h-8 text-green-700 mb-2" />
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-green-200">
              <DocumentTextIcon className="w-8 h-8 text-green-700 mb-2" />
      ...
      <div className="bg-green-50 py-6 border-y border-green-200">
        <div className="max-w-7xl mx-auto px-4 flex flex-wrap justify-center gap-8 text-center">
          <div><span className="font-bold text-green-800 text-2xl">10,000+</span><br />Teachers helped</div>
          <div><span className="font-bold text-green-800 text-2xl">50,000+</span><br />Resources generated</div>
          <div><span className="font-bold text-green-800 text-2xl">100%</span><br />Curriculum aligned</div>
        </div>
      </div>
