...
Please create a comprehensive lesson plan following the Zambian CDC curriculum and CBC framework.
...
Return the response in JSON format with these keys:
{
  ...
  "development": ["Step 1", "Step 2", "Step 3", "Step 4"],
  "activities": ["Activity 1", "Activity 2", "Activity 3"],
  "assessment": "Assessment description",
  "curriculumCodes": ["Code 1", "Code 2"]
}

Make the content relevant to ${grade} students in Zambia. Use examples appropriate for Zambian classrooms.
`;

        // Call DeepSeek API
        const completion = await deepseekClient.chat.completions.create({
            model: "deepseek-v4-flash", // Fast and cost-effective
            messages: [
                { 
                    role: "system", 
                    content: "You are a helpful assistant specialized in the Zambian education curriculum." 
                },
        ...
        // Fallback: return a mock lesson if API fails
        const { grade, subject, topic, classSize } = req.body;
